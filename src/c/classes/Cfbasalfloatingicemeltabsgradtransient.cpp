/*!\file Cfbasalfloatingicemeltabsgradtransient.cpp
 * \brief: Cfbasalfloatingicemeltabsgradtransient Object
 */
...
Cfbasalfloatingicemeltabsgradtransient::Cfbasalfloatingicemeltabsgradtransient(){/*{{{*/
...
/*}}}*/
Cfbasalfloatingicemeltabsgradtransient::Cfbasalfloatingicemeltabsgradtransient(char* in_name, int in_definitionenum, int in_num_datatimes, IssmDouble* in_datatimes, bool* in_passedflags, IssmDouble in_J){/*{{{*/
...
/*}}}*/
Cfbasalfloatingicemeltabsgradtransient::Cfbasalfloatingicemeltabsgradtransient(char* in_name, int in_definitionenum, int in_num_datatimes, IssmDouble* in_datatimes){/*{{{*/
...
Object* Cfbasalfloatingicemeltabsgradtransient::copy() {/*{{{*/
	Cfbasalfloatingicemeltabsgradtransient* mf = new Cfbasalfloatingicemeltabsgradtransient(this->name,this->definitionenum, this->num_datatimes, this->datatimes, this->passedflags, this->J);
	return (Object*) mf;
}
/*}}}*/
void Cfbasalfloatingicemeltabsgradtransient::DeepEcho(void){/*{{{*/
	this->Echo();
}
/*}}}*/
void Cfbasalfloatingicemeltabsgradtransient::Echo(void){/*{{{*/
	_printf_(" Cfbasalfloatingicemeltabsgradtransient: " << name << " " << this->definitionenum << "\n");
	_error_("not implemented yet");
}
/*}}}*/
int Cfbasalfloatingicemeltabsgradtransient::Id(void){/*{{{*/
	return -1;
}
/*}}}*/
void Cfbasalfloatingicemeltabsgradtransient::Marshall(MarshallHandle* marshallhandle){/*{{{*/

	/*ok, marshall operations: */
	int object_enum=CfbasalfloatingicemeltabsgradtransientEnum;
...
/*}}}*/
int Cfbasalfloatingicemeltabsgradtransient::ObjectEnum(void){/*{{{*/
	return CfbasalfloatingicemeltabsgradtransientEnum;
}
/*}}}*/
/*Definition virtual function resolutoin: */
int Cfbasalfloatingicemeltabsgradtransient::DefinitionEnum(){/*{{{*/
	return this->definitionenum;
}
/*}}}*/
char* Cfbasalfloatingicemeltabsgradtransient::Name(){/*{{{*/
...
/*}}}*/
IssmDouble Cfbasalfloatingicemeltabsgradtransient::Response(FemModel* femmodel){/*{{{*/
	...
	for(Object* & object : femmodel->elements->objects){
		...
		J_part+=this->Cfbasalfloatingicemeltabsgradtransient_Calculation(element);
	}
...
IssmDouble Cfbasalfloatingicemeltabsgradtransient::Cfbasalfloatingicemeltabsgradtransient_Calculation(Element* element){/*{{{*/
