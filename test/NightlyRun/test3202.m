...
models = {};
for current_training_index = 1:number_of_training_samples
	resolution = randi([25000 200000],1);
	initial_B = randi([1e7 1e9],1);
	...
	md.materials.rheology_B(1:end-1,:) = initial_B;
	...
	fprintf('\n%i/%i: Resolution: %i, Initial Rheology B: %0.2g\n\n', current_training_index, number_of_training_samples, resolution, initial_B);
	md=solve(md,'tr');
	...
	models{current_training_index} = md;
end
for i = 1:50:500
    md = models{i};plotmodel(md,'figure',i,'figposition','fullscreen',...
        'data',md.materials.rheology_B(1:end-1,1),...
        'data',md.materials.rheology_B(1:end-1,2),...
        'data','mesh',...
        'data',md.results.TransientSolution(1).Gradient1(:,1),...
        'data',md.results.TransientSolution(1).Gradient1(:,2),...
        'data',md.results.TransientSolution(1).Vel,...
        'title#1','Ice Rheology B t=0', ...
        'title#2','Ice Rheology B t=1', ...
        'title#3','Mesh',...
        'title#4','B Gradient t=0',...
        'title#5','B Gradient t=1',...
        'title#6','Velocity');
    field_name = sprintf('./Figures/Gradient_exp_%i',i);
    export_fig(gcf,field_name);
end